"""Resolve paths to files shipped with the installed sandburg package.
...
def _pkg_root() -> Path:
    """Return the filesystem path of the installed `sandburg` package."""
    return Path(str(files("sandburg")))
